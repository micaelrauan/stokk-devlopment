...
export default function AdminPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="glass-card p-1 inline-flex gap-1 mb-2 border border-border/50 rounded-xl">
        {TABS.map((t) => (
          <button
            key={t.value}
            className={`px-6 py-2 rounded-lg font-medium text-sm transition-all duration-200 focus:outline-none ${
              tab === t.value
