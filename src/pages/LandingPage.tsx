...
import { 
  ...
  CheckCircle2, Users, TrendingUp, Star, Sparkles,
  ShoppingBag, ScanBarcode, Bell, ChevronRight,
  Mail, Instagram, Code2, MousePointerClick
} from 'lucide-react';
...
export default function LandingPage() {
  ...
  const features = [
    { icon: Package, title: 'Grade Inteligente', desc: 'Gerencie variantes por tamanho, cor e SKU com matriz de grade visual e intuitiva.', color: 'from-blue-500/20 to-blue-600/5' },
    { icon: BarChart3, title: 'Dashboard em Tempo Real', desc: 'Métricas de vendas, faturamento, estoque e alertas em painéis dinâmicos.', color: 'from-emerald-500/20 to-emerald-600/5' },
    { icon: ShieldCheck, title: 'Segurança & Isolamento', desc: 'Dados isolados por empresa com autenticação robusta e criptografia.', color: 'from-violet-500/20 to-violet-600/5' },
    { icon: ScanBarcode, title: 'Leitor de Código de Barras', desc: 'Escaneie produtos direto pelo celular ou desktop com PDV integrado.', color: 'from-amber-500/20 to-amber-600/5' },
    { icon: Users, title: 'Multi-Empresa', desc: 'Cada empresa tem seu sistema completo e independente de estoque.', color: 'from-rose-500/20 to-rose-600/5' },
    { icon: Bell, title: 'Alertas Inteligentes', desc: 'Notificações automáticas de estoque baixo, esgotado e reposição.', color: 'from-cyan-500/20 to-cyan-600/5' },
  ];

  const steps = [
    { num: '01', title: 'Crie sua conta', desc: 'Cadastro rápido. Em menos de 1 minuto você já está dentro do sistema.' },
    { num: '02', title: 'Configure seu catálogo', desc: 'Adicione seus produtos, grades de tamanho, cores e defina preços.' },
    { num: '03', title: 'Gerencie tudo', desc: 'Controle vendas, estoque, etiquetas e acompanhe o crescimento.' },
  ];

  const plans = [
    { 
      name: 'Starter', price: 'R$ 0', period: '/mês', popular: false, gradient: '',
      features: ['Até 50 produtos', 'Até 100 vendas/mês', '1 usuário', 'Dashboard básico']
    },
    { 
      name: 'Profissional', price: 'R$ 99', period: '/mês', popular: true, gradient: 'bg-gradient-to-br from-foreground to-foreground/80',
    ...
    { 
      name: 'Premium', price: 'R$ 199', period: '/mês', popular: false, gradient: '',
  ...
  const testimonials = [
    { name: 'Maria Silva', role: 'Dona da Boutique Rosa', text: 'O Stokk transformou a gestão do meu estoque. Antes eu perdia vendas por não saber o que tinha disponível.', avatar: 'MS' },
    { name: 'Carlos Santos', role: 'Gerente de Loja', text: 'A grade de tamanhos e cores é perfeita para vestuário. O controle por SKU facilitou muito nosso dia a dia.', avatar: 'CS' },
    { name: 'Ana Oliveira', role: 'Empreendedora', text: 'Sistema intuitivo e completo. Os alertas de estoque baixo me ajudam a não perder nenhuma venda.', avatar: 'AO' },
  ];
    ...
    <div className="min-h-screen bg-background overflow-x-hidden">
      ...
      <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? 'bg-background/80 backdrop-blur-xl border-b border-border shadow-sm' : 'bg-transparent'}`}>
        <div className="max-w-7xl mx-auto flex items-center justify-between px-6 py-4">
          <div className="flex items-center gap-3">
            ...
            <span className="font-heading font-bold text-xl tracking-tight">Stokk</span>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <Button size="sm" onClick={() => navigate('/login')} className="gap-2 rounded-full px-5">
      ...
      <section className="relative pt-32 pb-24 px-6 overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-muted-foreground mt-8 max-w-2xl mx-auto leading-relaxed animate-in fade-in slide-in-from-bottom-5 duration-700 delay-200">
            Plataforma completa para gerenciar grades, cores, SKUs e vendas do seu negócio de moda. 
            Do cadastro à venda, tudo em um só lugar.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mt-10 animate-in fade-in slide-in-from-bottom-6 duration-700 delay-300">
            <Button size="lg" onClick={() => navigate('/login')} className="gap-2 text-base px-8 rounded-full h-12 shadow-lg shadow-primary/20 hover:shadow-xl hover:shadow-primary/30 transition-all">
              <MousePointerClick className="w-5 h-5" />
              Acessar Sistema
            </Button>
            <Button size="lg" variant="outline" onClick={() => document.getElementById('features')?.scrollIntoView({ behavior: 'smooth' })} className="text-base px-8 rounded-full h-12">
              Explorar Recursos
            </Button>
          </div>
        ...
        <div className="relative max-w-4xl mx-auto mt-20">
          <div className="glass-card rounded-2xl p-8 grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-0 md:divide-x divide-border">
            ...
            <div className="text-center" ref={stat2.ref}>
              <p className="text-4xl font-heading font-bold">{stat2.count.toLocaleString('pt-BR')}+</p>
              <p className="text-sm text-muted-foreground mt-1">Produtos gerenciados</p>
            </div>
            <div className="text-center" ref={stat3.ref}>
              <p className="text-4xl font-heading font-bold">{stat3.count}%</p>
              <p className="text-sm text-muted-foreground mt-1">Satisfação dos clientes</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="features" className="py-24 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <span className="text-sm font-medium text-primary/80 tracking-wider uppercase">Recursos</span>
      ...
      <section id="how" className="py-24 px-6 bg-muted/30">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            <span className="text-sm font-medium text-primary/80 tracking-wider uppercase">Como funciona</span>
            <h2 className="text-3xl md:text-5xl font-heading font-bold mt-3">
      ...
      <section id="pricing" className="py-24 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <span className="text-sm font-medium text-primary/80 tracking-wider uppercase">Planos</span>
            <h2 className="text-3xl md:text-5xl font-heading font-bold mt-3">
              Invista no crescimento
            </h2>
            <p className="text-muted-foreground mt-4 text-lg">Escolha o plano ideal para o tamanho do seu negócio.</p>
          </div>
                ...
                <ul className="mt-8 space-y-3.5">
                  {plan.features.map(f => (
                    <li key={f} className="flex items-center gap-2.5 text-sm">
                      <CheckCircle2 className={`w-4 h-4 shrink-0 ${plan.popular ? 'text-background/70' : 'text-emerald-500'}`} />
                      {f}
                    </li>
                  ))}
                </ul>
      ...
      <section id="testimonials" className="py-24 px-6 bg-muted/30">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <span className="text-sm font-medium text-primary/80 tracking-wider uppercase">Depoimentos</span>
            <h2 className="text-3xl md:text-5xl font-heading font-bold mt-3">
              Quem usa, recomenda
            </h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {testimonials.map(t => (
              <div key={t.name} className="glass-card rounded-2xl p-7 hover:shadow-lg transition-all duration-300">
          ...
          <div className="relative rounded-3xl bg-foreground text-background p-12 md:p-16 text-center overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-background/60 mt-4 text-lg max-w-xl mx-auto">
                Comece a usar o Stokk agora e transforme a gestão do seu estoque de moda.
              </p>
              <Button 
                size="lg" 
                onClick={() => navigate('/login')} 
      ...
      <footer className="border-t border-border py-12 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-10">
            ...
            {/* Links */}
            <div>
              <h4 className="font-heading font-semibold text-sm mb-4">Produto</h4>
            ...
            {/* Developer */}
            <div>
              <h4 className="font-heading font-semibold text-sm mb-4">Desenvolvido por</h4>
              <div className="space-y-2.5 text-sm text-muted-foreground">
                <div className="flex items-center gap-2">
                  <Code2 className="w-4 h-4 shrink-0" />
                  <span className="font-medium text-foreground">Kode</span>
                  <span className="text-muted-foreground">| Desenvolvimento Web</span>
                </div>
                <p className="text-xs text-muted-foreground">Profissional: Micael Rauan</p>
                <div className="flex items-center gap-2">
                  <Instagram className="w-4 h-4 shrink-0" />
                  <a href="https://instagram.com/kode.devbr" target="_blank" rel="noopener noreferrer" className="hover:text-foreground transition-colors">
                    @kode.devbr
                  </a>
                </div>
                <div className="flex items-center gap-2">
                  <Mail className="w-4 h-4 shrink-0" />
                  <a href="mailto:kode.dev.br@gmail.com" className="hover:text-foreground transition-colors">
          ...
          <div className="pt-8 border-t border-border flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <p className="text-xs text-muted-foreground flex items-center gap-1.5">
              ...
              <a href="https://instagram.com/kode.devbr" target="_blank" rel="noopener noreferrer" className="font-medium text-foreground hover:underline">
