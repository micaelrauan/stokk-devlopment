    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          Busque produtos pelo código de barras
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="glass-card rounded-xl p-6 space-y-4">
          ...
          <div className="text-xs text-muted-foreground">
            <p>
              Conecte um leitor USB de código de barras e escaneie diretamente
              neste campo.
            </p>
          </div>
            ...
            <div className="space-y-1 max-h-48 overflow-y-auto">
              {allBarcodes.slice(0, 8).map((b, i) => (
                <button
                  key={i}
                  onClick={() => {
                    setManualCode(b.barcode);
                    handleSearch(b.barcode);
                  }}
      ...
      {result && (
        <div className="glass-card rounded-xl p-6 border-l-4 border-l-success">
          <h3 className="text-lg font-heading font-semibold mb-4 text-success">
            Produto Encontrado
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              <div className="flex justify-between text-sm">
                ...
                <span className="font-mono">{result.variant.sku}</span>
              </div>
              <div className="flex justify-between text-sm">
              ...
              <div className="flex justify-between text-sm">
                ...
                <span className="font-bold">
                  R$ {result.product.salePrice.toFixed(2)}
                </span>
              </div>
              <div className="flex justify-between text-sm">
                ...
                <span
                  className={`font-bold ${
                    result.variant.currentStock === 0
                      ? "text-destructive"
                      : result.variant.currentStock <=
                          result.product.minStockThreshold
                        ? "text-warning"
                        : "text-success"
                  }`}
                >
                  {result.variant.currentStock} un.
                </span>
              </div>
            </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-1">
                Verifique o código ou cadastre o produto.
              </p>
            </div>
          </div>
        </div>
